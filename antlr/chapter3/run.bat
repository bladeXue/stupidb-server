@REM integration version partially from hello 0-run-all.bat

@REM delete generated files first
del src /Q

@REM generate the token files
java -jar ..\antlr-4.12.0-complete.jar -o .\src  ArrayInit.g4
...
@REM 3. -gui
java -cp ".\src;..\antlr-4.12.0-complete.jar" org.antlr.v4.gui.TestRig  ArrayInit init -gui
